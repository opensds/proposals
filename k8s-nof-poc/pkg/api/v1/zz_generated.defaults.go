...
func SetObjectDefaults_PersistentVolume(in *PersistentVolume) {
	...
	if in.Spec.PersistentVolumeSource.NVMEOF != nil {
		SetDefaults_NVMEOFVolumeSource(in.Spec.PersistentVolumeSource.NVMEOF)
	}
}
...
func SetObjectDefaults_Pod(in *Pod) {
	...
	for i := range in.Spec.Volumes {
		...
		if a.VolumeSource.NVMEOF != nil {
			SetDefaults_NVMEOFVolumeSource(a.VolumeSource.NVMEOF)
		}
	}
