...
type VolumeSource struct {
    ...
    // NVMEOF represents an NVMEOF Disk resource that is attached to a
    // kubelet's host machine and then exposed to the pod.
    // More info: http://releases.k8s.io/HEAD/examples/volumes/nvmeof/README.md
    // +optional
    NVMEOF *NVMEOFVolumeSource `json:"nvmeof,omitempty" protobuf:"bytes,24,opt,name=nvmeof"`
}
...
type PersistentVolumeSource struct {
    ...
    // More info: http://releases.k8s.io/HEAD/examples/volumes/nvmeof/README.md
    // +optional
    NVMEOF *NVMEOFVolumeSource `json:"nvmeof,omitempty" protobuf:"bytes,18,opt,name=nvmeof"`
}
...
// Represents an NVMEOF disk.
// NVMEOF volumes can only be mounted as read/write once.
// NVMEOF volumes support ownership management and SELinux relabeling.
type NVMEOFVolumeSource struct {
    // NVMe-oF transport type (e.g. rdma)
    // +optional
    Transport string `json:"transport" protobuf:"bytes,1,opt,name=transport"`
    // NVMe-oF target IP address
    // +optional
    TrAddr string `json:"traddr" protobuf:"bytes,2,opt,name=traddr"`
    // NVMe-oF target port number
    // +optional
    TrSvcId int32 `json:"trsvcid" protobuf:"varint,3,opt,name=trsvcid"`
    // Required: NVMe-oF target nqn
    // +optional
    Nqn string `json:"nqn" protobuf:"bytes,4,opt,name=nqn"`
    // Filesystem type of the volume that you want to mount.
    // Tip: Ensure that the filesystem type is supported by the host operating system.
    // Examples: "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
    // More info: http://kubernetes.io/docs/user-guide/volumes#iscsi
