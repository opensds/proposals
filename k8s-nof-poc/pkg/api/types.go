...
type VolumeSource struct {
    ...
    // NVMEOFVolumeSource represents an NVMEOF Disk resource that is attached to a
    // kubelet's host machine and then exposed to the pod.
    // +optional
    NVMEOF *NVMEOFVolumeSource
...
type NVMEOFVolumeSource struct {
    // Required: NVMe-oF transport type (e.g. rdma)
    // +optional
    Transport string
    // Required:  NVMe-oF target IP address
    // +optional
    TrAddr string
    // Required: NVMe-oF target port number
    // +optional
    TrSvcId int32
