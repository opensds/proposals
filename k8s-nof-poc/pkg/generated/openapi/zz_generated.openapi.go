...
var OpenAPIDefinitions *common.OpenAPIDefinitions = &common.OpenAPIDefinitions{
	...
	"v1.NVMEOFVolumeSource": {
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Represents an NVMEOF disk. NVMEOF volumes can only be mounted as read/write once. NVMEOF volumes support ownership management and SELinux relabeling.",
				Properties: map[string]spec.Schema{
					"transport": {
						SchemaProps: spec.SchemaProps{
							Description: "NVMe-oF transport type (e.g. rdma)",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"traddr": {
						SchemaProps: spec.SchemaProps{
							Description: "NVMe-oF target IP address",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"trsvcid": {
						SchemaProps: spec.SchemaProps{
							Description: "NVMe-oF target port number",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"nqn": {
						SchemaProps: spec.SchemaProps{
							Description: "Required: NVMe-oF target nqn",
							Type:        []string{"string"},
							Format:      "",
						},
					},
	...
	"v1.PersistentVolumeSource": {
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"nvmeof": {
						SchemaProps: spec.SchemaProps{
							Description: "NVMEOF represents an NVMEOF Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: http://releases.k8s.io/HEAD/examples/volumes/nvmeof/README.md",
							Ref:         spec.MustCreateRef("#/definitions/v1.NVMEOFVolumeSource"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"v1.AWSElasticBlockStoreVolumeSource", "v1.AzureDiskVolumeSource", "v1.AzureFileVolumeSource", "v1.CephFSVolumeSource", "v1.CinderVolumeSource", "v1.FCVolumeSource", "v1.FlexVolumeSource", "v1.FlockerVolumeSource", "v1.GCEPersistentDiskVolumeSource", "v1.GlusterfsVolumeSource", "v1.HostPathVolumeSource", "v1.ISCSIVolumeSource", "v1.NFSVolumeSource", "v1.NVMEOFVolumeSource", "v1.PhotonPersistentDiskVolumeSource", "v1.QuobyteVolumeSource", "v1.RBDVolumeSource", "v1.VsphereVirtualDiskVolumeSource"},
	},
	...
	"v1.Volume": {
		...
		Dependencies: []string{
			"v1.AWSElasticBlockStoreVolumeSource", "v1.AzureDiskVolumeSource", "v1.AzureFileVolumeSource", "v1.CephFSVolumeSource", "v1.CinderVolumeSource", "v1.ConfigMapVolumeSource", "v1.DownwardAPIVolumeSource", "v1.EmptyDirVolumeSource", "v1.FCVolumeSource", "v1.FlexVolumeSource", "v1.FlockerVolumeSource", "v1.GCEPersistentDiskVolumeSource", "v1.GitRepoVolumeSource", "v1.GlusterfsVolumeSource", "v1.HostPathVolumeSource", "v1.ISCSIVolumeSource", "v1.NFSVolumeSource", "v1.NVMEOFVolumeSource", "v1.PersistentVolumeClaimVolumeSource", "v1.PhotonPersistentDiskVolumeSource", "v1.QuobyteVolumeSource", "v1.RBDVolumeSource", "v1.SecretVolumeSource", "v1.VsphereVirtualDiskVolumeSource"},
	},
	"v1.VolumeMount": {
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
