...
"""RequestContext: context for requests that persist through all of sds."""
...
class RequestContext(object):
    ...
    # tenant/user whereas the Sds version uses project_id/user_id. We need
