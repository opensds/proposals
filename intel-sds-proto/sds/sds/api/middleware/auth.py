...
from sds.openstack.common.middleware import request_id
from sds.common import wsgi as base_wsgi
...
class InjectContext(base_wsgi.Middleware):
    """Add a 'sds.context' to WSGI environ."""
    ...
    def __call__(self, req):
        req.environ['sds.context'] = self.context
        return self.application


class SdsKeystoneContext(base_wsgi.Middleware):
