...
from sds.openstack.common import network_utils
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'sds.best_content_type' not in self.environ:
            ...
            self.environ['sds.best_content_type'] = (content_type or
                                                        'application/json')

        return self.environ['sds.best_content_type']
...
class Application(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = sds.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import sds.api.fancy_api
...
class Resource(Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('sds.context')
...
def _set_request_id_header(req, headers):
    context = req.environ.get('sds.context')
    if context:
...
class Server(object):
    ...
    def start(self):
        ...
        :returns: None
        :raises: sds.exception.InvalidInput
...
class Middleware(Application):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = sds.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import sds.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `sds.exception.PasteAppNotFound`
