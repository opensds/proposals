...
from sds.openstack.common import loopingcall
from sds.openstack.common import processutils
from sds.openstack.common import service
...
service_opts = [
    ...
    cfg.StrOpt('osapi_sds_listen',
               default="0.0.0.0",
               help='IP address on which OpenStack Volume API listens'),
    cfg.IntOpt('osapi_sds_listen_port',
               default=9776,
               help='Port on which OpenStack Volume API listens'),
    cfg.IntOpt('osapi_sds_workers',
               default=1,
               help='Number of workers for SDS Controller API service. '
...
class Service(service.Service):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'sds-' part
        ...
        if not topic:
            topic = binary
        if not manager:
            subtopic = topic.rpartition('sds-')[2]
