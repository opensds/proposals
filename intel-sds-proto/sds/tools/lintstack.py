...
# 'hashlib'.
ignore_messages = ["An attribute affected in sds.tests",
...
# checked elsewhere. We also ignore sds.tests for now due to high false
# positive rate.
ignore_modules = ["sds/openstack/common/", "sds/tests/"]
