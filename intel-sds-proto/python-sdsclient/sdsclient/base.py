...
from sdsclient.openstack.common.apiclient import base as common_base
...
class Manager(utils.HookableMixin):
    ...
    def completion_cache(self, cache_type, obj_class, mode):
        ...
        """
        base_dir = utils.env('SDSCLIENT_UUID_CACHE_DIR',
                             default="~/.sdsclient")

        # NOTE(sirp): Keep separate UUID caches for each username + endpoint
        # pair
        username = utils.env('OS_USERNAME', 'SDS_USERNAME')
        url = utils.env('OS_URL', 'SDS_URL')
