...
class SessionClient(adapter.LegacyJsonAdapter):
    ...
    def __init__(self, **kwargs):
        kwargs.setdefault('user_agent', 'python-sdsclient')
        kwargs.setdefault('service_type', 'sds')
    ...
    def _cs_request(self, url, method, **kwargs):
        ...
        #print("^^^ _cs_request url: %s, method: %s, args: %s" % (url, method, kwargs))
    ...
    def get_sds_api_version_from_endpoint(self):
        return get_sds_api_from_url(self._get_endpoint())
...
class HTTPClient(object):
    ...
    def __init__(self, user, password, projectid, auth_url=None,
                 ...
                 http_log_debug=True, cacert=None,
    ...
    def get_sds_api_version_from_endpoint(self):
        return get_sds_api_from_url(self.management_url)
    ...
    def _fetch_endpoints_from_auth(self, url):
        ...
        # GET ...:5001/v1.0/tokens/#####/endpoints
    ...
    def authenticate(self):
        ...
        if self.version == "v1.0":
            ...
            raise exceptions.UnsupportedVersion("invalid version")
