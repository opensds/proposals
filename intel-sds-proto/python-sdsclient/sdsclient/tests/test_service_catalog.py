...
from sdsclient import service_catalog
...
SERVICE_CATALOG = {
    "access": {
        ...
        "serviceCatalog": [
            ...
            {
                "name": "Sds Volume Service",
                "type": "sds",
                "endpoints": [
                    {
                        "tenantId": "1",
                        "publicURL": "https://sds1.host/v1/1234",
                        "internalURL": "https://sds1.host/v1/1234",
                        "region": "South",
                        "versionId": "1.0",
                        "versionInfo": "uri",
                        "versionList": "uri"
                    ...
                    {
                        "tenantId": "2",
                        "publicURL": "https://sds1.host/v1/3456",
                        "internalURL": "https://sds1.host/v1/3456",
                        "region": "South",
                        "versionId": "1.1",
                        "versionInfo": "https://sds1.host/v1/",
                        "versionList": "https://sds1.host/"
                    },
                ],
                "endpoints_links": [
                    {
            ...
            {
                "name": "Sds Volume Service V2",
                "type": "sdsv2",
                "endpoints": [
                    {
                        "tenantId": "1",
                        "publicURL": "https://sds1.host/v2/1234",
                        "internalURL": "https://sds1.host/v2/1234",
                        "region": "South",
                        "versionId": "2.0",
                        "versionInfo": "uri",
                        "versionList": "uri"
                    ...
                    {
                        "tenantId": "2",
                        "publicURL": "https://sds1.host/v2/3456",
                        "internalURL": "https://sds1.host/v2/3456",
                        "region": "South",
                        "versionId": "1.1",
                        "versionInfo": "https://sds1.host/v2/",
                        "versionList": "https://sds1.host/"
                    },
                ],
                "endpoints_links": [
...
class ServiceCatalogTest(utils.TestCase):
    ...
    def test_alternate_service_type(self):
        ...
        self.assertRaises(exceptions.AmbiguousEndpoints, sc.url_for,
                          service_type='sds')
        self.assertEqual("https://sds1.host/v1/1234",
                         sc.url_for('tenantId', '1', service_type='sds'))
        self.assertEqual("https://sds1.host/v1/3456",
                         sc.url_for('tenantId', '2', service_type='sds'))

        self.assertEqual("https://sds1.host/v2/3456",
                         sc.url_for('tenantId', '2', service_type='sdsv2'))
        self.assertEqual("https://sds1.host/v2/3456",
                         sc.url_for('tenantId', '2', service_type='sdsv2'))

        self.assertRaises(exceptions.EndpointNotFound, sc.url_for,
                          "region", "North", service_type='sds')

    def test_compatibility_service_type(self):
        sc = service_catalog.ServiceCatalog(SERVICE_COMPATIBILITY_CATALOG)

        self.assertEqual("https://sds1.host/v2/1234",
                         sc.url_for('tenantId', '1', service_type='sds'))
        self.assertEqual("https://sds1.host/v2/3456",
                         sc.url_for('tenantId', '2', service_type='sds'))
